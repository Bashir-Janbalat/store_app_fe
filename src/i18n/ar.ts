...
export const ar: Translations = {
    ...
    auth: {
        ...
        invalidPassword: "كلمة المرور يجب أن تحتوي على 8 أحرف على الأقل، حرف كبير، حرف صغير، وحرف خاص (مثل `@`, `#`, `$`).",
        userAlreadyExists: "يوجد مستخدم بالفعل بالبريد الإلكتروني '{{email}}'.",
    },
    footer: {
